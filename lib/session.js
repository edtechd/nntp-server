...
Session.prototype.writeBody = function (data) {
  ...
  this.in_stream.write(data[0]);
  this.in_stream.write("\r\n");
  this.in_stream.write(data[1]);
  this.in_stream.write("\r\n");
  this.in_stream.write(data[2]);
  this.in_stream.write("\r\n");
};
...
Session.prototype.tick = function () {
  ...
  if (cmd.state === CMD_RESOLVED) {
	if(cmd.cmd_line.indexOf('BODY')==0)
		this.writeBody(cmd.resolved_value);
	else
